...
async function slplscrape(arg) {
  ...
  await page.goto(
    `https://slpl.bibliocommons.com/v2/search?query=${arg}&searchType=keyword&_ga=2.220310552.1001473363.1676660508-317247585.1673290248&locale=en-US&f_FORMAT=BK&f_AUDIENCE=adult&f_FICTION_TYPE=NONFICTION`
  );
